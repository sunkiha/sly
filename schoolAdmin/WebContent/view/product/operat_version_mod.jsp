...
<body>
	...
	<form id="form1" method="post">
		<input name="id" class="mini-hidden" /> <input name="url"
			class="mini-hidden" />
			...
			<table style="table-layout: fixed;">
				<tr>
					...
					<td style="width: 150px;"><input name="type"
						...
						required="true" data="[{id:0,name:'android'},{id:1,name:'ios'}]"
						emptyText="" /></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td style="width: 150px;"><input id="app"
						class="mini-fileupload" limitSize="100MB" limitType="*.apk;*.ipa"
						flashUrl="view/miniui/swfupload.swf"
						uploadUrl="../../product/modVersion"
