...
<body>
	...
	<div style="width: 100%;">
		<div class="mini-toolbar" style="border-bottom: 0; padding: 0px;">
			<a class="mini-button" iconCls="icon-add" plain="true"
				onclick="add()">新增</a> <span style="padding-left: 5px;">版本：</span> <input
				id="num" class="mini-textbox" width="120" value="" vtype="int" /> <a
	...
	<div id="datagrid" class="mini-datagrid"
		...
		url="product/getVersionPage" idField="id" multiSelect="true"
		pageSize="20">
		<div property="columns">
			...
			<div field="num" width="50" headerAlign="center">版本</div>
			<div field="url" width="80" headerAlign="center">地址</div>
			<div renderer="type" width="40" headerAlign="center">类型</div>
	...
	<script type="text/javascript">
		...
		function mod() {
			...
			if (record) {
				mini.open({
					url : "view/product/operat_version_mod.jsp",
					title : "修改",
					width : 300,
					height : 200,
					onload : function() {
