			...
			<!-- 	<tr>
				...
				<tr>
					...
					<input
						...
						uploadUrl="../../product/addAtlas" onuploadsuccess="onUploadSuccess" onuploaderror="onUploadError" required="true"
				...
				<!-- 	<tr>
					...
					<td style="width: 150px;"><input name="videoUrl"
						class="mini-htmlfile" required="true" emptyText="" limitType="*.jpg;*.png"/></td>
				</tr> -->
