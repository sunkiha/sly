...
<body>
	...
	<div style="width: 100%;">
		<div class="mini-toolbar" style="border-bottom: 0; padding: 0px;">
			 <span style="padding-left: 5px;">手机号：</span> <input
	...
	<div id="datagrid" class="mini-datagrid"
		...
		url="product/getUserInfoPage" idField="id" multiSelect="true"
		pageSize="20">
		<div property="columns">
			...
			<div field="imsi" width="80" headerAlign="center">IMSI</div>
			<div field="imei" width="80" headerAlign="center">IMEI</div>
			<div renderer="os" width="50" headerAlign="center">平台</div>
