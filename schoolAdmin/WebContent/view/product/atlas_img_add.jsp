...
<link href="view/js/webupload/webuploader.css" rel="stylesheet"
	type="text/css">
<link rel="stylesheet" type="text/css"
	href="view/js/webupload/style.css" />
</head>
<body>
	...
	<script type="text/javascript" src="view/js/webupload/webuploader.js"></script>
	<script>
		var atlasId;
		mini.parse();
