...
<div id="layout1" class="mini-layout" style="width:100%;height:100%;">
    <div class="header" region="north" height="70" showSplit="false" showHeader="false">
        <h1 style="margin:0;padding:15px;cursor:default;font-family:微软雅黑,黑体,宋体;">孕产管家管理系统 </h1>
        <div style="position:absolute;top:18px;right:10px;">
          <%--  <!--  <a class="mini-button mini-button-iconTop" iconCls="icon-add" onclick="onQuickClick" plain="true">快捷</a>    
            ...
            ${user.username}&nbsp;<a href="userInfo/loginOut">退出</a> --%>
        </div>
    ...
    <div title="center" region="center" style="border:0;" bodyStyle="overflow:hidden;">
        ...
        <div class="mini-splitter" style="width:100%;height:100%;" borderStyle="border:0;">
            <div size="180" maxSize="250" minSize="100" showCollapseButton="true" style="border:0;">
                <!--OutlookTree-->
                <div id="leftTree" class="mini-outlooktree" url="view/data/left_menu.jsp" onnodeclick="onNodeSelect"
	...
	function showTab(node) {
		...
		if (!tab) {
			...
			//tab.url = mini_JSPath + "docs/api/" + node.id ;
			tab.url ="${basePath}"+node.id;
			tabs.addTab(tab);
		}
		tabs.activeTab(tab);
	}
