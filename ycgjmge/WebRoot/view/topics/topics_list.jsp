...
<body>
	<div style="width: 100%;">
		...
		<div style="padding-bottom: 5px;">
			...
			一级分类： <input id="circleCategoryId" name="circleCategoryId"
				onenter="onKeyEnter" class="mini-combobox" style="width: 150px;"
				...
				style="width: 150px;" textField="name" valueField="id" /> 主题：<input
	...
	<div id="datagrid1" class="mini-datagrid"
		...
		<div property="columns">
			...
			<div field="circleCategoryName" width="15">一级分类</div>
