		...
		<form id="upload" action="upload.aspx" method="post" enctype="multipart/form-data">
			...
			<div style="padding-left:11px;padding-bottom:5px;">
				<table style="table-layout:fixed;">
					<tr>
						<td style="width:70px;">人像：</td>
						<td style="width:150px;" >
							<input class="mini-htmlfile" name="Fdata" limitType="*.png" />
						</td>
					</tr>
					<tr>
						<td style="width:70px;">全家福：</td>
						<td style="width:150px;" >
							<input class="mini-htmlfile" name="Fdata" limitType="*.png" />
						</td>
					</tr>
					<tr>
						<td style="width:70px;">指纹1：</td>
					...
					<tr>
						<td style="width:70px;">指纹2：</td>
						<td style="width:150px;" colspan="3">
							<input class="mini-htmlfile" name="Fdata" limitType="*.png" />
						</td>
					</tr>
					<tr>
						<td style="width:70px;">指纹3：</td>
						<td style="width:150px;" colspan="3">
							<input class="mini-htmlfile" name="Fdata" limitType="*.png" />
						</td>
					</tr>
				...
				<div style="padding:5px;">
					<table>
						...
						<tr>
							<td>身高：</td>
							<td>
								<input name="heigh" class="mini-spinner"/>
							</td>
							<td>体重：</td>
							<td>
								<input name="weight" class="mini-spinner" required="true" emptyText="请选择日期" />
							</td>
						</tr>
						<tr>
							<td>详细地址：</td>
