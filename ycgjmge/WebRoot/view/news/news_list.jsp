...
<body>
	<div style="width: 100%;">
		...
		<div style="padding-bottom: 5px;">
			...
			新闻所属： <input id="type" name="type" onenter="onKeyEnter"
				...
				style="width: 150px;" textField="name" valueField="id" /> 标题：<input
	...
	<div id="datagrid1" class="mini-datagrid"
		...
		<div property="columns">
			...
			<div field="title" width="50">标题</div>
			<div field="name" width="10">分类</div>
			<div field="createDate" width="30" allowSort="true"
				dateFormat="yyyy-MM-dd HH:mm:dd">创建日期</div>
			<div field=countComment width="10">评论数</div>
