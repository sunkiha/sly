...
<body>
	<form id="equipmentFrom" action="circle/addCircle" method="post"
		...
		<div style="padding-left: 11px; padding-bottom: 5px;">
			<table align="center" style="table-layout: fixed;">
				<tr>
					...
					<td style="width: 100px;"><input id="circleCategory" name="circleCategoryId"  class="mini-combobox"
				style="width: 150px;" textField="name" valueField="id"
				valueFromSelect="true"  url="circle/getCircleCategoryAll"  /> </td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td style="width: 100px;"><input class="mini-htmlfile"
						name="banner" limitType="*.png;*.jpg" style="width: 150px;" /></td>
				</tr>
			</table>
		</div>
