...
<!-- 	<div style="width: 100%;">
	...
	<div id="datagrid1" class="mini-datagrid"
		...
		url="communitypost/getCommunitypostCommentList" idField="id"
		multiSelect="true">
	...
	<div id="replyWindow" class="mini-window" title="回复报告单"
		...
		<div id="replyFrom">
			...
			<button type="button" class="mini-button" onclick="doctorReply()" style="width: 60px;">确定</button>
			<button type="button"  class="mini-button"   onclick="closeW()" style="width: 60px;">取消</button>
			</div>
		</div>
	</div>
