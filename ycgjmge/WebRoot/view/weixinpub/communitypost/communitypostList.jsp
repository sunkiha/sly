...
<body>
	...
	<div id="datagrid1" class="mini-datagrid"
		...
		url="communitypost/getCommunitypostList" idField="id" multiSelect="true" pageSize="20">
		<div property="columns">
			<!--<div type="indexcolumn"></div>        -->
			<!-- <div type="checkcolumn"></div> -->
			<div field="username" width="50" headerAlign="center">用户</div>
			<div field="content" width="100">内容</div>
			<div field="createDate" width="80" allowSort="true"
				dateFormat="yyyy-MM-dd HH:mm:dd">创建日期</div>
				<div field="path" width="80" headerAlign="center"
	...
	<script type="text/javascript">
		...
		function path(e) {
			...
			var id = e.record.id;
			var s = '<img style="float:left" width="80px" height="40px src="http://60.174.233.153:8080/src/'+path+'.png"/><a style="float:left;margin-top:30px;margin-left:40px" href="javascript:seeMoreImg(\'' + id
			+ '\')">更多</a>';
			return s;
		}
		function add() {
		...
		function seeReply(id) {
			mini.open({
				url : "view/weixinpub/communitypost/communitypostCommenList.jsp",
				title : "查看回复",
				width : "80%",
				height : "70%",
				onload : function() {
		...
		function del(id) {
			mini.confirm("确定要删除吗?", "提示", function(data) {
				if (data == "ok") {
					$.ajax({
						url : "communitypost/delCommunitypost",
						data : {
							id : id
						},
		...
		function seeMoreImg(id) {
			mini.open({
				url : "communitypost/seeMoreImg?cpId="+id,
				title : "帖子图片",
				width : 900,
				height : 500,
				onload : function() {
