...
<body>
	<div style="width: 100%;">
		...
		<div style="padding-bottom: 5px;">
			...
			所属： <input id="type" name="type" onenter="onKeyEnter"
				...
				style="width: 20%;" textField="name" valueField="id" />
				状态： <input
				id="status" name="status" class="mini-combobox"
				style="width: 20%;" textField="name" valueField="value" data="statusR"/> 评论内容：<input
	...
	<div id="datagrid1" class="mini-datagrid"
		...
		<div property="columns">
			...
			<div field="createDate" width="35" allowSort="true"
				dateFormat="yyyy-MM-dd">评论日期</div>
