...
<body>
	<div style="width: 100%;">
		...
		<div style="padding-bottom: 5px;">
			 类型： <input id="type" onenter="onKeyEnter" class="mini-combobox"
				...
				valueFromSelect="true" data="typeData"  />  <a
	...
	<script type="text/javascript">
		...
		grid.load();
		grid.sortBy("hn.createdate", "desc");
		function operat(e) {
			var grid = e.sender;
			var record = e.record;
			var id = record.id;
			...
			var s = "<a href='javascript:void(0)' banner="+banner+"  id="+id+" onclick='del(this)'>删除</a>";
			return s;
		}
		function path(e) {
			var path = e.record.pic;
			var s = '<img style="float:left" height="50px" width="100px" src="http://60.174.233.153:8080/src/'+path+'.png"/>';
			return s;
		}
		function add() {
			mini.open({
