...
<body>
	<div style="width: 100%;">
		...
		<div style="padding-bottom: 5px;">
			类型： <input id="type" onenter="onKeyEnter" class="mini-combobox" placeholder="sdfdf"
	...
	<script type="text/javascript">
		...
		function add() {
			mini.open({
				url : "view/weixinpub/news/news_category_add.jsp",
				title : "新增",
				width : 250,
				height : 150,
				onload : function() {
		...
		function mod(obj) {
			...
			mini.open({
				url : "view/weixinpub/news/news_category_mod.jsp",
				title : "修改",
				width : 250,
				height : 150,
				onload : function() {
