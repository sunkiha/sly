...
<body>
	...
	<div id="datagrid1" class="mini-datagrid"
		...
		url="careRemind/getBeiYunList" idField="id" multiSelect="true">
		<div property="columns">
			<!--<div type="indexcolumn"></div>        -->
			<!-- <div type="checkcolumn"></div> -->
			<div field="day" width="30">天数</div>
			<div field="talk" width="120">陈述</div>
				<div field="statusPic" width="50" headerAlign="center"
	...
	<script type="text/javascript">
		...
		function add() {
			mini.open({
				url : "view/weixinpub/careRemind/addBeiyun.jsp",
				title : "新增",
				width : "80%",
				height : "50%",
				onload : function() {
		...
		function mod(id) {
			mini.open({
				url : "view/weixinpub/careRemind/modBeiyun.jsp",
				title : "修改",
				width : "80%",
				height : "50%",
				onload : function() {
		...
		function del(id) {
			mini.confirm("确定要删除吗?", "提示", function(data) {
				if (data == "ok") {
					$.ajax({
						url : "careRemind/deleteBeiyunCareRemindById",
						data : {
							id : id
						},
