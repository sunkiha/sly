...
<body>
	<div style="width: 100%;">
		...
		<div style="padding-bottom: 5px;">
			周数： <input id="week" onenter="onKeyEnter" class="mini-combobox"
				style="width: 150px;" textField="name" valueField="value"
				valueFromSelect="true" url="careRemind/getWeeks" /> <a
	...
	<div id="datagrid1" class="mini-datagrid"
		...
		url="careRemind/getHuaiYunList" idField="id" multiSelect="true">
		<div property="columns">
			<!--<div type="indexcolumn"></div>        -->
			<!-- <div type="checkcolumn"></div> -->
			<div field="weekNum" width="20">周数</div>
			<div field="talk" width="100">陈述</div>
				<div field="statusPic" width="60" headerAlign="center"
	...
	<script type="text/javascript">
		...
		function statusPic(e) {
			...
			var s = '<img width="70px" height="70px" src="http://60.174.233.153:8080/src/'+statusPic+'.png"/>';
			return s;
		}
		function add() {
			mini.open({
				url : "view/weixinpub/careRemind/addHuaiyun.jsp",
				title : "新增",
				width : "80%",
				height : "50%",
				onload : function() {
		...
		function mod(id) {
			mini.open({
				url : "view/weixinpub/careRemind/modHuaiyun.jsp",
				title : "修改",
				width : "65%",
				height : "50%",
				onload : function() {
		...
		function del(id) {
			mini.confirm("确定要删除吗?", "提示", function(data) {
				if (data == "ok") {
					$.ajax({
						url : "careRemind/deleteHuaiyunCareRemindById",
						data : {
							id : id
						},
