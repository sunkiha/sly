...
<body>
	<form id="equipmentFrom" action="careRemind/modHuaiyun" method="post"
		...
		<div style="padding-left: 11px; padding-bottom: 5px;">
			<table align="center" style="table-layout: fixed;">
				<tr>
					...
					<td style="">
					<input name="weekNum"
						class="mini-combobox" style="" textField="name"
						valueField="value" valueFromSelect="true"
						url="careRemind/getWeeks" /></td>
				</tr>
				<tr>
					<td style="">状态图片：</td>
				...
				<tr>
					<td style="">陈述：</td>
					<td style=""><textarea class="mini-TextArea" name="talk" width="150px" height="150" >
						</textarea></td>
				</tr>
			</table>
		</div>
