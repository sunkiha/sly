...
<body>
	<form id="equipmentFrom" action="tumorMenu2/add" method="post"
		enctype="multipart/form-data" onsubmit="return post()">
		<input type="hidden" name="tumorId" class="mini-hidden"
			value="${tumorId}" /> <input type="hidden" name="id"
			class="mini-hidden" />
		<div style="padding-left: 11px; padding-bottom: 5px;">
			<table align="center" style="table-layout: fixed;">
				<tr>
					<td style="width: 70px;">文章分类：</td>
					<td style="width: 150px;"><input id="tumorMenuId"
						name="tumorMenuId" class="mini-combobox" style="width: 150px;"
						textField="name" valueField="id" url="tumorMenu2/getTumorMenu" />
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td style="width: 150px;"><textarea id="editor" name="content"
							class="" style="width: 800px; height: 300px;"></textarea>
					</td>
				</tr>
			</table>
		</div>
	...
	function post(){
		...
		// getLocalData();
		function isFocus(e) {
			mini.alert(UE.getEditor('editor').isFocus());
