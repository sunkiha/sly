...
<body>
	<form id="equipmentFrom" action="communityTopic/addCommunityTopic"
		method="post" enctype="multipart/form-data" onsubmit="return post()">
