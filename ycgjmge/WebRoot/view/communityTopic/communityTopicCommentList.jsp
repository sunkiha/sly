...
<body>
	...
	<div id="datagrid1" class="mini-datagrid"
		...
		url="communityTopic/getCommunityTopicList" idField="id"
		multiSelect="true">
		<div property="columns">
			<!--<div type="indexcolumn"></div>        -->
			<!-- <div type="checkcolumn"></div> -->
			<div field="id" width="30" headerAlign="center">编号</div>
			<div field="img" width="80" headerAlign="center"
				renderer="path">状态图</div>
			<div field="name" width="120">名称</div>
			<div field="desc" width="120">描述</div>
	...
	<script type="text/javascript">
		...
		function path(e) {
			...
			var id = e.record.id;
			var s = '<img style="float:left" width="80px" src="http://60.174.233.153:8080/src/'+path+'.png"/>';
			return s;
		}
		function add() {
			mini.open({
