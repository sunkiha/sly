...
<body>
	...
	<div id="datagrid1" class="mini-datagrid"
		...
		url="inspectReport/getInspectreportListReply?id=${id}" idField="id"
		multiSelect="true">
		<div property="columns">
			<!--<div type="indexcolumn"></div>        -->
			<!-- <div type="checkcolumn"></div> -->
			<div field="username" width="70" headerAlign="center">用户</div>
			<div field="content" width="80">内容</div>
			...
			<div style="padding-left: 11px; padding-bottom: 5px;">
				<table align="center" style="table-layout: fixed;">
					<tr>
						...
						<td style="width: 80px;"><input class="mini-textbox"
								name="content" width="200px"  height="200px"
								 required="true"/>
						</td>
					</tr>
				</table>
