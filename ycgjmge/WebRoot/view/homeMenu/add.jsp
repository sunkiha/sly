...
<body>
	<form id="equipmentFrom" action="homeMenu/add" method="post" onsubmit="return post()"
		enctype="multipart/form-data">
        <input type="hidden" name="homeMenuId" class="mini-hidden" value="${homeMenuId}"/>
			...
			<table align="center" style="table-layout: fixed;">
				...
				<tr>
					...
					<td style="width: 150px;">
					    <textarea  name="summary" class="" style="width: 300px; height: 100px;"></textarea>
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td style="width: 150px;">
					    <textarea id="editor" name="content" rows="300" cols="800" style="width: 800px; height: 300px;"></textarea>
					</td>
				</tr>
			</table>
		</div>
