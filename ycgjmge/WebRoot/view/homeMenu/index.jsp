...
<body>
	...
	<div id="datagrid1" class="mini-datagrid"
		...
		url="homeMenu/getHomeMenuContentPage?homeMenuId=${homeMenuId}" idField="id" multiSelect="true">
	...
	<script type="text/javascript">
		...
		function operat(e) {
			...
			var s =  '<a class="Edit_Button" href="javascript:detail(\'' + id
					+ '\')">查看</a> '
		...
		function banner(e){
			...
			var s ='<img width="80px" src="http://60.174.233.153:8080/src/zhongliu/'+banner+'.png?t="+'+Math.random()+'/>';
			return s;
		}
		function add() {
			mini.open({
				url : "homeMenu/toAdd?homeMenuId=${homeMenuId}",
				title : "新增",
				width : 900,
				height : 500,
				onload : function() {
