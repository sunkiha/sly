...
疾病名称:<input id="btnEdit1" class="mini-buttonedit" onbuttonclick="onTumor" name="a" textName="b"/> 
			标题：
				<input id="title"
				  style="width: 150px;"
	...
	<div id="datagrid1" class="mini-datagrid"
		...
		url="tumorMenu/getTumorMenuContentPage?tumorMenuId=${tumorMenuId}" idField="id" multiSelect="true">
