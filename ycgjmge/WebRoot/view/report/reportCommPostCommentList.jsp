...
<body>
	...
	<div id="datagrid1" class="mini-datagrid"
		...
		url="report/getReportCommPostCommentList" idField="id" pageSize="20"
		multiSelect="true">
		<div property="columns">
			<!--<div type="indexcolumn"></div>        -->
			<!-- <div type="checkcolumn"></div> -->
			<div field="reportUserName" width="100" headerAlign="center">举报人</div>
			<div field="username" width="100">评论人</div>
	...
	var typeData = [{name:"评论",value:1 },{name:"帖子",value:0 }];
		...
		function operat(e) {
			var grid = e.sender;
			var record = e.record;
			var communitypostCommentId = record.communitypostCommentId;
			var reportId = record.id;
			var rowIndex = e.rowIndex;
			var s = '<a class="Delete_Button" href="javascript:del(\''+communitypostCommentId+','+reportId
					+ '\')">删除该评论</a> ';
			return s;
		}
		function banner(e) {
		...
		function del(str) {
			...
			mini.confirm("确定要删除吗?", "提示", function(data) {
				if (data == "ok") {
					$.ajax({
						url : "report/delCommunitypostComment",
						data : {
							communitypostCommentId:a[0],
							reportId:a[1]
						},
