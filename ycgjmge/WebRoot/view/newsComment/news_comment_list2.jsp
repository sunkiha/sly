...
<body>
	<div style="width: 100%;">
		...
		<div style="padding-bottom: 5px;">
			<!-- 日期： <input id="datepicker" class="mini-datepicker"
				style="width: 150px;" /> -->
			新闻所属： <input id="type" name="type" onenter="onKeyEnter"
				class="mini-combobox" style="width: 100px;" textField="name"
				valueField="value" onvaluechanged="onTypeChanged"
				valueFromSelect="true" data="typeData" /> 新闻分类： <input
				id="category" name="category" class="mini-combobox"
				style="width: 100px;" textField="name" valueField="id" />
				审核状态： <input
	...
	<div id="datagrid1" class="mini-datagrid"
		style="width: 100%; height: 100%;" allowResize="true"
		url="newsComment/getNewsComment" idField="id" multiSelect="true" pageSize="20">
		<div property="columns">
			<!--<div type="indexcolumn"></div>        -->
			<!-- <div type="checkcolumn"></div> -->
